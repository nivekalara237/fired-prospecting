...
export class ObjetComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.objetService
                ...
                .subscribe(
                    (res: HttpResponse<IObjet[]>) => this.paginateObjets(res.body, res.headers),
    ...
    trackId(index: number, item: IObjet) {
        return item.id;
    }
    ...
    protected paginateObjets(data: IObjet[], headers: HttpHeaders) {
