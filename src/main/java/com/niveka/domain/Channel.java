...
public class Channel implements Serializable {
    ...
    public Channel designation(String designation) {
    ...
    public Channel entrepriseId(String entrepriseId) {
    ...
    public Channel updatedAt(String updatedAt) {
    ...
    public Channel deletedAt(String deletedAt) {
    ...
    public Channel entreprise(Entreprise entreprise) {
