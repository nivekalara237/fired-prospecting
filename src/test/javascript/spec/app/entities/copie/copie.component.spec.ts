...
import { CopieComponent } from 'app/entities/copie/copie.component';
import { CopieService } from 'app/entities/copie/copie.service';
import { Copie } from 'app/shared/model/copie.model';

describe('Component Tests', () => {
    describe('Copie Management Component', () => {
        let comp: CopieComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CopieComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.copies[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
